...
package com.enfle.android.camera.preview;
...
import com.enfle.android.camera.utils.VideoQuality;
        ...
        switch (videoQuality) {
            case Constants.VIDEO_QUALITY_QVGA:
                if (hasProfile(cameraId, CamcorderProfile.QUALITY_QVGA)) {
                    ...
                    return getCamcorderProfile(Constants.VIDEO_QUALITY_LOWEST, cameraId);
                }
                break;
            ...
            case Constants.VIDEO_QUALITY_480P:
                if (hasProfile(cameraId, CamcorderProfile.QUALITY_480P)) {
                    ...
                    return getCamcorderProfile(Constants.VIDEO_QUALITY_QVGA, cameraId);
                }
                break;
            ...
            case Constants.VIDEO_QUALITY_720P:
                if (hasProfile(cameraId, CamcorderProfile.QUALITY_720P)) {
                    ...
                    return getCamcorderProfile(Constants.VIDEO_QUALITY_480P, cameraId);
                }
                break;
            ...
            case Constants.VIDEO_QUALITY_1080P:
                if (hasProfile(cameraId, CamcorderProfile.QUALITY_1080P)) {
                    ...
                    return getCamcorderProfile(Constants.VIDEO_QUALITY_720P, cameraId);
                }
                break;
            ...
            case Constants.VIDEO_QUALITY_2160P:
                try {
                    ...
                    return getCamcorderProfile(Constants.VIDEO_QUALITY_HIGHEST, cameraId);
                }
                break;
